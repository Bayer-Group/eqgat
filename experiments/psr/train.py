...
from experiments.psr.data import (
    DATA_DIR,
    GNNTransformPSR,
    LMDBDataset,
)
...
try:
    ...
    PATH = "experiments/psr/data"
    MODEL_DIR = "experiments/psr/models"
...
class PSRDataLightning(pl.LightningDataModule):
    def __init__(
        self,
        root,
        transform,
        ...
        super(PSRDataLightning, self).__init__()
...
class PSRmodel(pl.LightningModule):
    def __init__(
        self,
        args,
        sdim: int = 128,
...
def get_argparse():
    parser = ArgumentParser(
        description="Main training script for Equivariant GNNs on PSR Data."
    )
    ...
    parser.add_argument("--use_cutoff_fnc", action="store_true", default=False)
